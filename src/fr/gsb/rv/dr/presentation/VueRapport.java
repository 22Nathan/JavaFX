...
public class VueRapport extends Dialog {
	...
	this.setHeaderText("Rapport Visite : n°" + leRapport.getNumero() 
                    + "\nVisiteur : " + leRapport.getLeVisiteur().getPrenom() 
                    + " " + leRapport.getLeVisiteur().getNom().toUpperCase());
	...
	Label bilan = new Label("Bilan : " + leRapport.getBilan() 
                    + "  Motif : " + leRapport.getMotif());
